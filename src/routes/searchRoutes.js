...
const { globalSearch, suggest, popular, reindexLabs, reindexProducts, reindexPages, reindexAll } = require('../controllers/searchController');
const { protect, allowRoles } = require('../middleware/authMiddleware');

router.get('/popular', popular);
router.get('/suggest', suggest);
router.get('/', globalSearch);
router.post('/reindex/all', protect, allowRoles('superadmin'), reindexAll);
