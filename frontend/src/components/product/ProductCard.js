...
export default function ProductCard({ product }) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 hover:border-primary-200 hover:shadow-lg transition-all p-7 flex flex-col text-center">
      ...
      {inCart ? (
        <Link
          href="/cart"
          className="mt-4 flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-green-600 hover:bg-green-700 text-white font-bold text-sm transition-colors shadow-sm"
        >
          <FiCheck /> View Cart
        </Link>
      ) : (
        <button
          ...
          className="mt-4 flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-primary-600 hover:bg-primary-700 active:bg-primary-800 text-white font-bold text-sm transition-colors shadow-sm"
        >
