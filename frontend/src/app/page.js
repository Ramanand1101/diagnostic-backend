...
const features = [
  {
    ...
    desc: 'All partner labs are NABL / CAP accredited and rigorously verified.',
  ...
  },
  {
    ...
    desc: 'Receive your test report digitally within hours, not days.',
  ...
  },
  {
    ...
    desc: 'Our trained phlebotomists collect samples at your doorstep.',
  ...
  },
  {
    icon: FiAward,
    title: 'Best Prices',
    desc: 'Transparent pricing with no hidden fees and exclusive discounts.',
...
const steps = [
  {
    ...
    desc: 'Browse 500+ tests and packages. Compare prices across certified labs in your city.',
  },
  {
    number: '02',
    icon: FiCalendar,
    title: 'Book Your Slot',
    desc: 'Choose home collection or walk-in. Pick a time that fits your schedule.',
  },
  {
    number: '03',
    icon: FiFileText,
    title: 'Get Your Report',
    desc: 'Receive your digital report securely in your dashboard within hours.',
  },
];
...
const popularTests = [
  { name: 'CBC Test', slug: 'cbc', icon: MdOutlineBloodtype, color: 'text-red-500', bg: 'bg-red-50' },
  { name: 'Thyroid Panel', slug: 'thyroid', icon: TbHeartbeat, color: 'text-pink-500', bg: 'bg-pink-50' },
  { name: 'Vitamin D', slug: 'vitamin-d', icon: MdOutlineScience, color: 'text-yellow-500', bg: 'bg-yellow-50' },
  { name: 'HbA1c', slug: 'hba1c', icon: TbVirus, color: 'text-purple-500', bg: 'bg-purple-50' },
  { name: 'Lipid Profile', slug: 'lipid', icon: FiActivity, color: 'text-blue-500', bg: 'bg-blue-50' },
  { name: 'Liver Function', slug: 'liver', icon: FiShield, color: 'text-green-500', bg: 'bg-green-50' },
];
  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="py-16 bg-[#F8FAFC]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-sm text-gray-500 mt-2">Book your lab test in 3 simple steps</p>
            </div>
        ...
        {/* ── Popular tests (static quick-access) ── */}
        <section className="py-14 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
              {popularTests.map(({ name, slug, icon: Icon, color, bg }) => (
                <Link
                  key={slug}
                ...
                >
                  <div className={`w-12 h-12 ${bg} rounded-full flex items-center justify-center group-hover:scale-110 transition-transform`}>
        ...
        <section className="bg-gradient-to-br from-primary-700 to-primary-900 py-14">
          <div className="max-w-4xl mx-auto px-4 text-center text-white">
            <h2 className="text-2xl md:text-3xl font-bold mb-3">India&apos;s Most Trusted Lab Booking Platform</h2>
            <p className="text-primary-200 mb-8 text-base">
              We partner only with NABL &amp; CAP certified labs to ensure accurate, reliable results every time.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/products?type=test" className="bg-white text-primary-700 font-semibold px-7 py-3 rounded-xl hover:bg-primary-50 transition-colors shadow-lg">
                Book a Test
              </Link>
              <Link href="/labs" className="border-2 border-white/40 text-white font-semibold px-7 py-3 rounded-xl hover:bg-white/10 transition-colors">
                Find a Lab
              </Link>
            </div>
          </div>
